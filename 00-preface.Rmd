...
> 📎 **Note for Educators**: CDI guides are best delivered as **live web resources** (via GitHub Pages).  
> We recommend embedding links inside your LMS — this ensures students always access the most updated version.  
> Learners can still “Print to PDF” from their browser for offline reading if needed.
